...
//call an function and then take all data;
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <p class="fw-bolder"><span>Total Rate:</span>${product.rating.count}</p>
    <p class="fw-bolder"><span>Avg.Ratings:</span>${product.rating.rate}</p>
...
//update and count number of items added in the cart;
let count = 0;
